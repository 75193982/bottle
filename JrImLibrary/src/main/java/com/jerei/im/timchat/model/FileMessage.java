...
public class FileMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(IMContext.getContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        return IMContext.getContext().getString(R.string.summary_file);
    }
