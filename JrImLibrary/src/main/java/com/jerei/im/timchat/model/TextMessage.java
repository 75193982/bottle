            ...
            switch (message.getElement(i).getType()){
                case Face:
                    ...
                    try{
                        ...
                        Bitmap  resizedBitmap2 = BitmapCompressTools.zoomImage(resizedBitmap,tv.getTextSize()*1.5,tv.getTextSize()*1.5) ;
                        resizedBitmap.recycle();
                        bitmap.recycle();
                        ImageSpan span = new ImageSpan(context, resizedBitmap2, ImageSpan.ALIGN_BASELINE);
