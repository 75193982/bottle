...
import com.jerei.im.timchat.ui.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation {
    ...
    public GroupManageConversation(TIMGroupPendencyItem message){
        lastMessage = message;
        name = IMContext.getContext().getString(R.string.conversation_system_group);
    }
        ...
        switch (lastMessage.getPendencyType()){
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    ...
                    return from+ IMContext.getContext().getResources().getString(R.string.summary_group_apply)+ GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
