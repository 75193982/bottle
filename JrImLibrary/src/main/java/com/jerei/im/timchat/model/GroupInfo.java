...
public class GroupInfo implements Observer {
    ...
    private void refresh(){
        ...
        for (TIMGroupCacheInfo item : groupInfos){
            ...
            for(GroupProfile groupProfile:list){
                if( groupProfile.getIdentify().equals(item.getGroupInfo().getGroupId())){
                    have = true;
                }
            }
            if(!have){
    ...
    public static String getTypeName(String type){
        if (type.equals(GroupInfo.publicGroup)){
            return IMContext.getContext().getString(R.string.public_group);
        }else if (type.equals(GroupInfo.privateGroup)){
            return IMContext.getContext().getString(R.string.discuss_group);
        }else if (type.equals(GroupInfo.chatRoom)){
            return IMContext.getContext().getString(R.string.chatroom);
        }
        return "";
    }
