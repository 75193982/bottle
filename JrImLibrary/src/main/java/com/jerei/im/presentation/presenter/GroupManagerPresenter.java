...
import com.jerei.im.presentation.viewfeatures.GroupManageView;
...
public class GroupManagerPresenter {
     ...
     * @param cb
     */
    public static void modifyGroupIntroduction(java.lang.String groupId,
                                      java.lang.String introduction,
                                      TIMCallBack cb){
        TIMGroupManager.getInstance().modifyGroupIntroduction(groupId, introduction, cb);
    }
     ...
     * @param callBack 回调
     */
    public static void createGroup(String name, String type, List<String> members, String introduction,String url,TIMValueCallBack<String> callBack){
        ...
        groupGroupParam.setIntroduction(introduction);
        groupGroupParam.setFaceUrl(url);
     ...
     * @param members 成员
     */
    public static void addMember(String groupId,  List<String> members){
        //将list中的用户加入群组
        TIMGroupManager.getInstance().inviteGroupMember(
                ...
                new TIMValueCallBack<List<TIMGroupMemberResult>>() {
                    ...
                    public void onError(int code, String desc) {
                        Log.d("失败", "code: " + code  //操作结果:  0:添加失败；1：添加成功；2：原本是群成员
                                + " desc: " + desc);
                    }
                    ...
                    public void onSuccess(List<TIMGroupMemberResult> results) { //群组成员操作结果
                        for(TIMGroupMemberResult r : results) {
                            Log.d("成功", "result: " + r.getResult()  //操作结果:  0:添加失败；1：添加成功；2：原本是群成员
                                    + " user: " + r.getUser());    //用户帐号
                        }
                    }
                });
