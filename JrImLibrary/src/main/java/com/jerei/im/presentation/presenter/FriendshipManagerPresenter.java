...
import com.jerei.im.presentation.viewfeatures.FriendInfoView;
...
public class FriendshipManagerPresenter {
     ...
     * 按照ID搜索好友
     *
     * 搜索好友功能  去自己服务器上查询 想办法在主工程里实现
     *
     * @param identify id
     */
    public void searchFriendById(final String identify,final Context context){
