...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    private void initView(){
        ...
        LinearLayout btnLoc = (LinearLayout) findViewById(R.id.btn_loc);
        ...
        for (int i = 0; i < 5; ++i){
            ...
            for (int j = 0;j < 7; ++j){
                ...
                try{
                    ...
                    image.setPadding(padding,padding,padding,0);
                    image.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, screenWidth/7-padding, 1f));
                    ...
                    image.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ImageSpan span = new ImageSpan(getContext(),BitmapCompressTools.zoomImage(resizedBitmap,editText.getHeight()-25,editText.getHeight()-25), ImageSpan.ALIGN_BASELINE);
