package com.bottle.com.bottle.model;
...
import com.bottle.com.bottle.application.MyApplication;
import com.bottle.com.bottle.utils.EmoticonUtil;
...
public class TextMessage extends Message {
    ...
    public TextMessage(Editable s){
        ...
        for (ImageSpan span : listSpans){
            ...
            SpannableString expressionString = ExpressionUtil.getExpressionString(MyApplication.getContext(), s.subSequence(startIndex, endIndex).toString(), "^\\[:.{1,8}\\]$");
             s.append(expressionString);
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        SpannableString expressionString = ExpressionUtil.getExpressionString(context, stringBuilder.toString(),"\\[:[\u4e00-\u9fa5a-zA-Z]{0,5}\\]" );
        tv.setText(expressionString);
