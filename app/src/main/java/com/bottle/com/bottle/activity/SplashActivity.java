...
import com.bottle.com.bottle.model.UserInfo;
import com.bottle.com.bottle.presentation.business.InitBusiness;
import com.bottle.com.bottle.presentation.business.LoginBusiness;
import com.bottle.com.bottle.presentation.event.FriendshipEvent;
import com.bottle.com.bottle.presentation.event.GroupEvent;
import com.bottle.com.bottle.presentation.event.MessageEvent;
import com.bottle.com.bottle.presentation.event.RefreshEvent;
import com.bottle.com.bottle.presentation.presenter.SplashPresenter;
import com.bottle.com.bottle.presentation.viewfeatures.SplashView;
import com.bottle.com.bottle.utils.PushUtil;
import com.bottle.com.bottle.view.NotifyDialog;
...
//        MiPushClient.clearNotification(getApplicationContext());
   ...
   /* @Override
    ...
    private void init(){
        ...
        //初始化TLS
        SharedPreferences pref2 =getSharedPreferences("imlogin", MODE_PRIVATE);
        UserInfo.getInstance().setUserSig("eJxFkNFOwjAUht9ltxhty1qoCRc60U6ngzg0ctNM2kFBS1M6GDO*u6UZMTlX35eT--znJyqy18vSGCV46Xjfiug6AtFFwLIxykpeVk5ajyHGGAFwtntpd2qrvUAAYoj6APxLJaR2qlJh8VsqPxB2bqeWHj6Pp0ma9NC7T3nTTtt7USU9msl6sGY4XzWfDK2oPLKXLE-xRt2o22lbpPO79mOyfkTtFTPl0z4eA0Nc0TDwRfJJe6hhzWbzh*VodA4TGx7qnQrE-sA4HhLaSefvCsXAAFJC6LDj5WKxrbXj7mhk*MfvH7auWLk_");
        UserInfo.getInstance().setId("meimei11");
