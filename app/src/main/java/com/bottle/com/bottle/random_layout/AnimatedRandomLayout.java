 ...
 * @attention
 * 使用此随机布局，必须重写{@link OnCreateItemViewListener}回调接口的{@linkcreateItemView}
 * 方法，来定义用于随机布局的子控件
 * @author Windsander
 *
 */
...
//工具包方法/**************************************************************************************/
	...
	public void setItemShowCount(int itemShowCount){
		this.mItemShowCount = 10;//(itemShowCount > 1) ?itemShowCount : 1;
	}
